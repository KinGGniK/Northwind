...
namespace ProjectNorthwind1.Models
{
    public class DbConnection
    {
        ...
        //Edit Tables
        public void EditEmployees(int empid, string lname, string fname, string title, string titofcourt, DateTime bdate, DateTime hdate, string addy, string city, string region, string postal, string country, string hphone, string exten, string photo, string notes, int repto)
        {
            //string aSQL = " EXEC UpdateEmployees @empid= '" + empid + ", @lname='" + lname + ", @fname='" + fname + ", @title='" + title + ", @titleofcourt='" + titofcourt + ", @bdate='" + bdate + ", @hdate='" + hdate + ", @addy='" + addy + ", @city='" + city + ", @region='" + region + ", @postal='" + postal + ", @country='" + country + ", @hphone='" + hphone + ", @exten='" + exten + ", @photo='" + photo + ", @notes='" + notes + ", @reportsto='" + repto;
            string aSQL = "INSERT INTO Employees (LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo) VALUES('" + lname + "', '" + fname + "', '" + title + "', '" + titofcourt + "', '" + bdate + "', '" + hdate + "', '" + addy + "', '" + city + "', '" + region + "', '" + postal + "', '" + country + "', '" + hphone + "', '" + exten + "', '" + photo + "', '" + notes + "', '" + repto + "') WHERE EmployeeID = " + empid + ";";

            aConnection.ConnectionString = @"Provider=SQLOLEDB;Data Source=NOVINSKII-HP\SQLSERVER1;Initial Catalog=NorthwindSQL;Integrated Security=SSPI;";
            aConnection.Open();
        ...
        public void EditCategory(int catid, string name, string desc)
        {
            string aSQL = "EXEC [UpdateCategory] @aCategoryName = '" + name + "', @aDescription = '" + desc + "', @aCategoryID = " + catid + ";";
        ...
        public void EditShippers(int id, string compname, string phone)
        {
            //string aSQL = " EXEC UpdateEmployees @empid= '" + empid + ", @lname='" + lname + ", @fname='" + fname + ", @title='" + title + ", @titleofcourt='" + titofcourt + ", @bdate='" + bdate + ", @hdate='" + hdate + ", @addy='" + addy + ", @city='" + city + ", @region='" + region + ", @postal='" + postal + ", @country='" + country + ", @hphone='" + hphone + ", @exten='" + exten + ", @photo='" + photo + ", @notes='" + notes + ", @reportsto='" + repto;
            string aSQL = "INSERT INTO Shippers (CompanyName, Phone) VALUES('" + compname + "', '" + phone + "') WHERE ShipperID = " + id + ";";
        ...
        public void EditCustomer(string id, string compname, string name, string title, string addy, string city, string reg, string post, string country, string phone, string fax)
        {
            //string aSQL = " EXEC UpdateEmployees @empid= '" + empid + ", @lname='" + lname + ", @fname='" + fname + ", @title='" + title + ", @titleofcourt='" + titofcourt + ", @bdate='" + bdate + ", @hdate='" + hdate + ", @addy='" + addy + ", @city='" + city + ", @region='" + region + ", @postal='" + postal + ", @country='" + country + ", @hphone='" + hphone + ", @exten='" + exten + ", @photo='" + photo + ", @notes='" + notes + ", @reportsto='" + repto;
            string aSQL = "INSERT INTO Customers (CompanyName, Phone) VALUES('" + compname + "', '" + phone + "') WHERE ShipperID = " + id + ";";
        ...
        //Insert into Tables
        public void InsertEmployees(string lname, string fname, string title, string titofcourt, DateTime bdate, DateTime hdate, string addy, string city, string region, string postal, string country, string hphone, string exten, string photo, string notes, int repto)
        {

            string aSQL = "EXEC InsertEmployees @lname='" + lname + "', @fname='" + fname + "', @title='" + title + "', @titleofcourt='" + titofcourt + "', @bdate='" + bdate + "', @hdate='" + hdate + "', @addy='" + addy + "', @city='" + city + "', @region='" + region + "', @postal='" + postal + "', @country='" + country + "', @hphone='" + hphone + "', @exten='" + exten + "', @photo='" + photo + "', @notes='" + notes + "', @reportsto=" + repto + ";";
        ...
        {
            string aSQL = "EXEC InsertCategory @aCategoryName = '" + name + "', @aDescription = '" + desc + "';";
        ...
        {
            string aSQL = "EXEC DeleteCategory @aCategoryID = " + catid + "'";
        ...
        //Select Categories from JSON
        public List<Category> JSONListCategories()
        {
            string aSQL = "EXEC JSONCategories";
        ...
        //Select Categories from XML
        public List<Category> XMLListCategories()
        {
            string aSQL = "EXEC XMLCategories";
